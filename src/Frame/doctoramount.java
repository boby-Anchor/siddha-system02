...
public class doctoramount extends javax.swing.JFrame {
 ...
 public static String d1;
  ...
  public static String t1;
    ...
    public doctoramount() {
        initComponents();
          systemLogger.initLogger(doctoramount.class).info("Open Doctoramount Frame");
   ...
   agent_la_home_img.setVisible(false);
    ...
    private void initComponents() {
        ...
        jTable_d_a.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Doctor ID", "Doctor Name", "Contact Number", "Amount", "Bank Name", "Baranch Name", "Account Number"
            }
        ) {
...
//>>>>>>>>> search <<<<<<<<<<<      
    private void search(String d1 , String d2) {
       ...
       try{
        ...
        ResultSet rs =DBClass.getData("select da.iddoctor,d.doctorname,d.doctortell,d.doctorbankname,d.doctorbankbranchname,d.doctorbankacountnumber "
                + ",sum(da.amount) as 'S' "
                + "from doctoramount da inner join doctor d on da.iddoctor=d.iddoctor"
                + " where da.date between '"+d1+"' and '"+d2+"' group by da.iddoctor ");
     
           while (rs.next()) {
                Vector v = new Vector();
                    v.add(rs.getString("da.iddoctor"));
                    v.add(rs.getString("d.doctorname"));
                    v.add(rs.getString("d.doctortell"));
                    v.add(rs.getString("S"));
                    v.add(rs.getString("d.doctorbankname"));
                    v.add(rs.getString("d.doctorbankbranchname"));
                    v.add(rs.getString("d.doctorbankacountnumber"));
                    defTabMod.addRow(v);
                }
           netToatl();
            }
             ...
             systemLogger.initLogger(doctoramount.class).error(" search() Error",e);
           JOptionPane.showMessageDialog(null, "Error Not Selected Amount Date  !!! /n search() /n" , "Error Massage", JOptionPane.ERROR_MESSAGE); 
       }
    }
//>>>>>>>>> search <<<<<<<<<<<         
...
private void printInvoice() {
            ...
            try {
                //FileInputStream is = new FileInputStream("F:\\SADFInal\\01_1_siddha_System\\src\\Report\\DoctorAmount.jasper");
                  FileInputStream is = new FileInputStream(SaveFilePath.REPORT_File_path+"\\DoctorAmount.jasper");
                ...
                try {
                    ...
                    File file = new File(SaveFilePath.REPORT_BASE_URL + "\\DDRR3.txt");
                    if (!file.exists()) {
                        ...
                        fr.write("DB.map_DocAmo=" + pathPDF);
                        fr.close();
                        File pF = new File(pathPDF);
                        pF.mkdir();
                    }

                    InputStream input = new FileInputStream(SaveFilePath.REPORT_BASE_URL + "\\DDRR3.txt");
                    Properties prop = new Properties();
                    prop.load(input);
                    pathPDF = prop.getProperty("DB.map_DocAmo");
                    //  System.out.println(prop.getProperty("DB.mpa"));

                    JasperExportManager.exportReportToPdfFile(fileReport, pathPDF + "\\" +d1+"_"+t1+"_"+d2+"_"+"_Monthly Doctor Amount.pdf");
...
//   JasperExportManager.exportReportToXmlFile(fileReport, pathPDF + "\\\\" + GenaratorXMLName(tx_refno_jLayeredPane_invoice.getText()),true);
                    ...
                    // e.printStackTrace();
                     systemLogger.initLogger(doctoramount.class).error(" printInvoice() IOException Error",e);
                    ...
                    systemLogger.initLogger(doctoramount.class).error(" printInvoice() JRException Error",e);
                ...
                // e.printStackTrace();
                    systemLogger.initLogger(doctoramount.class).error(" printInvoice() Exception Error",e);
...
//---------########---------*********************---------########---------*********************---------########---------\\ 
     ...
     */
//>>>>>>>>> Get Instance <<<<<<<<<<<  
    private static final doctoramount doctor = new doctoramount();
