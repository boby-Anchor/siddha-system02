 ...
 * @author CHETHANA
 */
public class rxtotal extends javax.swing.JFrame {
 UniversalMethod u = new UniversalMethod();
 public static String d1;
  public static String d2;
  public static String t1;
    /**
     * Creates new form rxtotal
     */
    public rxtotal() {
        initComponents();
          systemLogger.initLogger(rxtotal.class).info("Open RX Toatal Frame");
   ...
   agent_la_home_img.setVisible(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(rxtotal.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
...
//>>>>>>>>> search <<<<<<<<<<<      
    private void search(String d1 , String d2) {
       ...
       try{
        ...
        ResultSet rs =DBClass.getData("select rx_idrx,date,time,total,discount,nettotal,shippingcost,fullamount "
                +"from invoicerx  where date between '"+d1+"' and '"+d2+"'  ");
     
           while (rs.next()) {
                Vector v = new Vector();
                    v.add(rs.getString("rx_idrx"));
           ...
           systemLogger.initLogger(rxtotal.class).error("search()  Error",e);
...
private void printInvoice() {
            ...
            try {
               // FileInputStream is = new FileInputStream("F:\\SADFInal\\01_1_siddha_System\\src\\Report\\RxTotal.jasper");
                 FileInputStream is = new FileInputStream(SaveFilePath.REPORT_File_path+"\\RxTotal.jasper");
                ...
                try {
                    ...
                    File file = new File(SaveFilePath.REPORT_BASE_URL + "\\DDRR6.txt");
                    if (!file.exists()) {
                        ...
                        fr.write("DB.map_rx_Total=" + pathPDF);
                        fr.close();
                        File pF = new File(pathPDF);
                        pF.mkdir();
                    }

                    InputStream input = new FileInputStream(SaveFilePath.REPORT_BASE_URL + "\\DDRR6.txt");
                    Properties prop = new Properties();
                    prop.load(input);
                    pathPDF = prop.getProperty("DB.map_rx_Total");
                    //  System.out.println(prop.getProperty("DB.mpa"));

                    JasperExportManager.exportReportToPdfFile(fileReport, pathPDF + "\\"+d1+"_"+t1+"_"+d2+"_RX Total.pdf");
                    ...
                    systemLogger.initLogger(rxtotal.class).error("printInvoice() IOException  Error",e);
                    // e.printStackTrace();
                ...
                systemLogger.initLogger(rxtotal.class).error("printInvoice() JRException Error",e);
                ...
                systemLogger.initLogger(rxtotal.class).error("printInvoice() Exception Error",e);
                // e.printStackTrace();
...
//---------########---------*********************---------########---------*********************---------########---------\\ 
     ...
     */
//>>>>>>>>> Get Instance <<<<<<<<<<<  
    private static final rxtotal doctor = new rxtotal();

    public static rxtotal getCallPopup() {
        return doctor;
    }
//>>>>>>>>> Get Instance <<<<<<<<<<<         
